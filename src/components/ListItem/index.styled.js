...
const animatedItemWithDragAnimation = posed.li({
  init: { x: 100 },
  enter: { opacity: 1, x: 0 },
  ...dragAnimation,
});

export const ListItem = styled(animatedItem)`
...
export const ListItemWithDragAnimation = styled(animatedItemWithDragAnimation)`
  list-style-type: none;
  background-color: white;
  cursor: pointer;
  padding: 15px;
